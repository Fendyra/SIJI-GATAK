  ...
  return (
    <div className="max-w-[800px] w-full">
      <div className="flex justify-between items-start mb-6">
        ...
        <button className="flex items-center gap-2 cursor-pointer bg-white border border-card-border rounded-[10px] px-3.5 py-2 text-[13px] font-bold text-gray-700 hover:bg-gray-50 transition-colors">

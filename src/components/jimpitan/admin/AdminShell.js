  ...
  return (
    <div className={`flex min-h-screen ${vm.isMobile ? "flex-col" : "flex-row"}`}>
      ...
      <div className="min-w-0 flex-1 overflow-y-auto flex flex-col" style={{ padding: vm.contentPadding }}>
        ...
        {/* FOOTER */}
        <div className="mt-8 border-t border-gray-200 pt-6 pb-6 flex flex-col items-center justify-center gap-1.5 text-center">
          <div className="text-[12px] text-gray-500">
            &copy; {new Date().getFullYear()} <strong className="font-extrabold text-gray-700">SIJI GATAK</strong> &mdash; Sistem Informasi Jimpitan Online Dusun Gatak
          </div>
          <div className="text-[12px] text-gray-500">
            Dikembangkan sebagai <strong className="font-extrabold text-gray-700">Program Kerja Utama Kelompok KKN UPN &quot;Veteran&quot; Yogyakarta 84.036</strong>
          </div>
        </div>
      </div>
    </div>
